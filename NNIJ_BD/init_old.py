...
from NNIJ_BD.models_old import Teacher, Student, Group, Mark, Subject, TeacherStudent, TeacherSubject, StudentMark, SubjectMark, GroupStudent, GroupTeacher, SubjectStudent
